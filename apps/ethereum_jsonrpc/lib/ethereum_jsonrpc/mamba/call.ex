defmodule EthereumJSONRPC.Mamba.Call do
  @moduledoc """
  ...
  A call can call another another contract:
      ...
      iex> EthereumJSONRPC.Mamba.Call.to_internal_transaction_params(
      ...>   %{
      ...>     "blockNumber" => 3287375,
      ...>     "transactionIndex" => 13,
  ...
  A call can run out of gas:
      ...
      iex> EthereumJSONRPC.Mamba.to_internal_transaction_params(
      ...>   %{
      ...>     "blockNumber" => 3293221,
      ...>     "transactionIndex" => 16,
